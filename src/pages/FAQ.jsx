                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            Frequently asked questions about how to use the ONEverse Marketplace. If this does not fulfill your question, please feel free to contact us on <a href="https://discord.gg/ONEverse" target="_blank" rel="noreferrer" style={{textDecoration: 'underline'}}>Discord</a>
                            </h5>
                        </div>
                        <div className="col-md-12">
