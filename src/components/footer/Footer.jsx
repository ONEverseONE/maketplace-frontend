                        ...
                        <div className="col-lg-3 col-md-12 col-12">
                            <div className="widget widget-logo">
                                <div className="logo-footer" id="logo-footer">
                                    <Link to="/">
                                        <img className='logo-dark' id="logo_footer" src={logofooter} width="245px" alt="nft-gaming" />
                                        <img className='logo-light' id="logo_footer" src={logofooter} width="245px" alt="nft-gaming" />
                                    </Link>
                                </div>
